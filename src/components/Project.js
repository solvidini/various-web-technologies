...
const Project = (props) => {
    ...
    githubButton = (
      ...
      >
        ...
        <div className="custom-label custom-label--project custom-label--project--1">
          {context.dictionary.examples.project.noGithubLink}
        </div>
      </span>
    );
  } else {
  ...
  if (live) {
    previewButton = (
      ...
      >
        {mobile
          ? context.dictionary.examples.project.install
          : context.dictionary.examples.project.preview}
      </a>
    );
  } else {
    previewButton = (
      ...
      >
        ...
        <div className="custom-label custom-label--project custom-label--project--2">
          {context.dictionary.examples.project.noLiveLink}
        </div>
      </span>
    );
  }
